      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <!-- #################### TAB-1 HOMEPAGE ####################-->
          <div id="evaluatorHomepage" class="tab-pane fade in active">
           ...
           <div class="row">
                  <div class="col-lg-3">
                    <h3><span id="examType" class="label label-success">SELECT EXAM TYPE</span></h3>
                    <select id="examTypeSelect" class="form-control" placeholder=".col-lg-4">
                    </select>
                  </div>
                  <div class="col-lg-3">
                    <h3><span id="subjectCode" class="label label-success">SELECT SUBJECT CODE</span></h3>
              ...
              <br>
                <input type = "button" class="btn btn-lg btn-success" value ="GO" onclick="fetch()"/>
              </div>
