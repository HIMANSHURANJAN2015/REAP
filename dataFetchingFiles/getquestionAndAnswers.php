...
$query = "SELECT DISTINCT a.URL,a.image_id,b.marks,b.comments,c.question_num,c.question_text,c.expected_answer,e.eval_first_name,e.eval_last_name from image a, marks_comments b, question c,question_paper d,evaluator e WHERE 
			(c.qp_id = ".$qp_id['qp_id'].")
			AND (a.image_id = b.image_id) 
			AND (a.USN = '$USN')
			AND (a.evaluation_done = '1')
