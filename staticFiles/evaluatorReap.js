...
xhr.onreadystatechange= function(){
  ...
  //
    xhr.open("GET","http://localhost/REAP/dataFetchingFiles/question_and_answer.php?qp_id=1"+"&qno="+questionNumber,false);
  xhr.send();
...
function save(event) 
{
 ...
 if(isNaN(marks)) {
  ...
  alert("You haven't enter marks yet !! You can save your comments and later on give marks");
